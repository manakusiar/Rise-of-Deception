...
## instantiates this node, attaches it to the caster, hands it the AbilityData
...
var data: AbilityData     # the AbilityData it was spawned from

func activate(p_source: Node, aim_direction: Vector2, p_data: AbilityData) -> void:
	source = p_source
	data = p_data
