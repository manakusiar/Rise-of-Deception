extends Node
class_name ComponentEntityInventory

var item_node_group: Node2D
@export var inventory: Dictionary[Utils.ItemID, DataItem]
...
func Load_Save_Data(data: Dictionary[Utils.ItemID, DataItem]) -> void:
	inventory = data
